...
server.get("/skapaAnvandare", async (request, response) => {
  ...
  response.sendFile(path.join(__dirname, "skapaAnvandare.html"))
});
...
server.get("/auth/github", (_request, response) => {
  const authUrl =
    "https://github.com/login/oauth/authorize?client_id=75edbf9d4ba6ee0ddb5b";
...
server.get("/auth/github/callback", async (request, response) => {
  ...
  const githubResponse = await fetch("https://github.com/login/oauth/access_token", {
    ...
    body: new URLSearchParams({
      client_id: "75edbf9d4ba6ee0ddb5b",
      client_secret: "46a59c999f1e6c83ec95acf9c533278c2679fb33",
      code: code,
    }),
